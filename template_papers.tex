...
\subsection{Security Issues in Lightweight Cryptography}   % 2
...
% - explain how traditional cryptographic techniques are unsuitable for such environments and highlight the differences. - dhanda2020lightweight: p.6
